...
\begin{enumerate}[1.]
    % ((550 + 500) × 5 + 5000) × 4 = 41000
    \item Opti-MEMを必要量分注する。
    ...
    \begin{table}[hbtp]
        ...
        \begin{tabular}{|l|c|c|}
            ...
            試薬名 & 溶液1 & 溶液2 \\
            \hline
            Opti-MEM & $500\mathrm{\mu M} + 50\mathrm{\mu  L} \times 4 = 2200\mathrm{\mu L} $ & $500\mathrm{\mu M} \times 4 = 2000\mathrm{\mu L}$ \\
            各プラスミド溶液(hTGR5, CRE-luc, \beta-gal) & - & $2.5\mathrm{\mu L} \times 4 = 10\mathrm{\mu L}$ \\
            Lipofectamine 3000 Reagent & $7.5\mathrm{\mu L} + 0.75\mathrm{µL} \times 4 = 33\mathrm{\mu L}$& - \\
            P3000 Reagent & - & $15\mathrm{\mu L} \times 4 = 60\mathrm{\mu L}$ \\
            \hline
        \end{tabular}
...
\begin{enumerate}[1.]
    ...
    \item 新しいGM$2\mathrm{mL}$を加え、ペレットを懸濁する。
    \item トリパンブルー色素排除染色法により、セルカウントを行う。
    \item 24well plateに、$4.0 \times 10^5 \mathrm{cells/well}$になるように撒く。
\end{enumerate}
...
\begin{enumerate}[1.]
    ...
    \begin{table}[hbtp]
        ...
        \begin{tabular}{|c|c|c|c|c|c|}
            \hline
            control & DCA only & PPL & PPD & PPH & PPV \\
            \hline
            control & DCA only & PPL & PPD & PPH & PPV \\
            \hline
            control & DCA only & PPL & PPD & PPH & PPV \\
